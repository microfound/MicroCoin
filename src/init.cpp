...
std::string HelpMessage()
{
    ...
    strUsage += "  -addhttpseed=<ip>      " + _("Connect to a node over HTTP to retrieve peer addresses and disconnect") + "\n";
    ...
    strUsage += "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 12107 or testnet: 7121)") + "\n";
